...
public class ReWriterConfig {
     ...
     * 必须是全路径形式，不是点分形式的包名
     */
    public static String sAgentClassName = 'com/vcredit/hbcollection/PluginAgent'
    ...
    */
    ...
    static {
        ...
        sActivityMethods.put('onPause()V', new MethodCell(
                ...
                0, 1,
                [Opcodes.ALOAD]))
        sActivityMethods.put('dispatchTouchEvent(Landroid/view/MotionEvent;)Z', new MethodCell(
                'dispatchTouchEvent',
                '(Landroid/view/MotionEvent;)Z',
                '',
                'onActivityTouch',
                '(Ljava/lang/Object;Landroid/view/MotionEvent;)V',
                0, 2,
                [Opcodes.ALOAD,Opcodes.ALOAD]))
    }

    public final static HashMap<String, MethodCell> sAppMethods = new HashMap<>()
    static {
        sAppMethods.put('onTrimMemory(I)V', new MethodCell(
                'onTrimMemory',
                '(I)V',
                '',// android/app/Application 或 android/support/multidex/MultiDexApplication
                'onTrimMemory',
